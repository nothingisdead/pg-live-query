					...
					while (1) switch (context$2$0.prev = context$2$0.next) {
						...
						case 27:
							...
							if (queryDetails.isUpdatable) {
								try {
									_this.selectBuffer[queryHash].parsed = sqlParser.parse(query);
								} catch (error) {}
							}
				...
				return _regeneratorRuntime.async(function _updateQuery$(context$2$0) {
					while (1) switch (context$2$0.prev = context$2$0.next) {
						...
						case 2:
							...
							context$2$0.next = 8;
							return common.getDiffFromSupplied(pgHandle.client, queryBuffer.notifications.splice(0, queryBuffer.notifications.length), queryBuffer.parsed, queryBuffer.params);
