...
function listen(callback) {
	...
	this.getClient(function (error, client, done) {
		...
		client.on("notification", function (info) {
			...
			var _info$payload$split2 = _slicedToArray(_info$payload$split, 4);

			var messageId = _info$payload$split2[0];
			var part = _info$payload$split2[1];
			var max = _info$payload$split2[2];
			var text = _info$payload$split2[3];
